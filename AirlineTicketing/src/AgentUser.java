...
public class AgentUser extends User{
	...
	AgentUser(String Username, String Password, String FName, String LName){
    ...
    public void insertUser(){
		...
		try {
	    	...
	    	try {
	    	    String str = "INSERT INTO AGENT_USER (Username, Password, FName, LName) " +
	    	            "VALUES (?, ?, ?, ?)";
    ...
    public static boolean checkValidUser(String username, String password) throws IOException {
        ...
        String query = "SELECT COUNT(*) AS count FROM AGENT_USER WHERE Username = ? AND Password = ?";
